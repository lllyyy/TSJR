...
- (UIView *)alertView {
    if (!_alertView) {
        ...
        _alertView.backgroundColor = JCL_Cell_COL;
    }
    return _alertView;
}
...
- (UIView *)topView {
    if (!_topView) {
        ...
        _topView.backgroundColor = JCL_Cell_COL;
    }
    return _topView;
}
...
- (UIButton *)leftBtn {
    if (!_leftBtn) {
        ...
        [_leftBtn setTitleColor:TitleCColor forState:UIControlStateNormal];
...
- (UIButton *)rightBtn {
    if (!_rightBtn) {
        ...
        [_rightBtn setTitleColor:MAIN_COLOR forState:UIControlStateNormal];
...
//        _lineView.backgroundColor  = [UIColor colorWithRed:225 / 255.0 green:225 / 255.0 blue:225 / 255.0 alpha:1.0];
        _lineView.backgroundColor = JCL_Bg_COL;
