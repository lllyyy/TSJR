...
@protocol TSJRSelectivityAlertViewDelegate;/** 定义一个协议*/
...
@interface TSJRYSelectivityAlertView : UIView<UITableViewDelegate,UITableViewDataSource>
 ...
 * @abstract 设置代理
 */
@property (nonatomic,assign) id<TSJRSelectivityAlertViewDelegate>delegate;
 ...
 * @abstract 代理协议
 */
@protocol TSJRSelectivityAlertViewDelegate <NSObject>
