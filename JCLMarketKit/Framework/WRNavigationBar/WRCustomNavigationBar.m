...
-(void)updateFrame
{
   ...
   // self.rightButton.frame = CGRectMake(kWRScreenWidth - buttonWidth - margin-10, top, buttonWidth, buttonHeight);
...
- (void)wr_setRightButtonWithNormal:(UIImage *)normal highlighted:(UIImage *)highlighted title:(NSString *)title titleColor:(UIColor *)titleColor
{
    ...
    [self.rightButton setTitleColor:RGBACOLOR(255, 255, 255, 0.5) forState:UIControlStateDisabled];
